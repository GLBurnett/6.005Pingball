board name=boardConstructorValidWithAllGadgets gravity = 25.0
...
#define some portals
#portal1 and portal2 on same board
#portal2 connected to portal3 on different board
portal name=portal1 x=6 y=5 otherPortal=portal2
portal name=portal2 x=16 y=15 otherPortal=portal3
portal name = portal3 x=5 y=17 otherBoard = Mercury otherPortal = portal2
...
fire trigger=portal1 action=lFlipper3