board name=boardConstructorInvalidFire gravity = 25.0
...
fire trigger=CircleAwd action=rFlipper1
fire trigger=Abs123 action=lFlipper145
fire trigger=Abs2 action=lFlipper24
fire trigger=Abs1 action=Abs2A